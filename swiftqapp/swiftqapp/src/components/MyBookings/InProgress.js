...
const InProgress = (props) => {
  ...
  console.log("inProgess userData ", userData);
  ...
  const getUsers = async () => {
    ...
    setBookings(
      response.data.filter((item) => item.userBookingStatus === "INPROGRESS")
    );
  };
  ...
  return (
    <div className="site-card-wrapper centerHeader">
      <div className="row">
        <div className="col-md-12 mt-3 centerHeader">
          <h1 style={{ color: "#113344" }}>Today's Bookings(In Progress)</h1>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-md-12 mt-3 centerHeader">
          <h1 style={{ color: "#625d5d" }}>All Bookings(In Progress)</h1>
        </div>
      </div>
